            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    String sql = "UPDATE clients " +
                        "SET idid=@,firstName=@firstName,lastName=@lastName,phoneNumber=@phoneNumber,cellPhoneNumber=@cellPhoneNumber,email=@email,birthDate=@birthDate,firstShot=@firstShot,secondShot=@secondShot,thirdShot=@thirdShot,fourthShot=@fourthShot,vaccine1Manufacturer=@vaccine1Manufacturer,vaccine2Manufacturer=@vaccine2Manufacturer,vaccine3Manufacturer=@vaccine3Manufacturer,vaccine4Manufacturer=@vaccine4Manufacturer,positiveDate=@positiveDate,coronaRecovery=@coronaRecovery " +
                        "WHERE id=@id";
                    using (SqlCommand command = new SqlCommand(sql, connection))
                    {
